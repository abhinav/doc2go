...
func TestRenderPackage_headers(t *testing.T) {
	...
	assert.Equal(t, []header{
		...
		{4, "DoStuff", "func DoStuff"},
		{5, "hdr-Doer_of_stuff", "Doer of stuff"},
		{3, "pkg-types", "Types"},
		{4, "SomeType", "type SomeType"},
		{5, "hdr-My_type", "My type"},
		{5, "hdr-Default_Some_Type", "Default Some Type"},
		{5, "hdr-Shared_Some_Type", "Shared Some Type"},
		{5, "NewSomeType", "func NewSomeType"},
		{6, "hdr-Constructor", "Constructor"},
		{5, "SomeType.Print", "func (SomeType) Print"},
		{6, "hdr-Method", "Method"},
	}, headers)
}
